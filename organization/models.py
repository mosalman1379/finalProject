...
class Organization(models.Model):
    ...
    production_crop = models.ManyToManyField(Manufacture_Product, related_name='product_entry', verbose_name=_('production crop'))
    contact_fullname = models.CharField(max_length=100, verbose_name=_('contact full name'))
    contact_mobile = models.CharField(validators=[mobile_phone_regex], verbose_name=_('contact mobile number'),max_length=11)
